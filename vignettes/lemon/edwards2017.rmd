...
knitr::opts_chunk$set(fig.width=5.5, fig.height=5.5/4*3, fig.path='edwards2017-',
                      cache=FALSE, autodep = TRUE, cache.path = 'cache/')
```
...
\code{theme(legend.direction)} or \code{guide_legend(...)}.
...
```{r}
reposition_legend(p %+% aes(color=cyl, size=qsec), position = 'top right')
