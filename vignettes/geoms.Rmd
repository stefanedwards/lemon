...
point <- ggplot(sunspots, aes(x=year, y=count)) + geom_point() + geom_line() + labs(main='geom_point')
pointline <- ggplot(sunspots, aes(x=year, y=count)) + geom_pointline(distance=unit(3, 'pt')) + labs(main='geom_pointline')
