...
#' Points and line
#' 
#' Combines \code{geom_point} and \code{geom_line} into a single geom.
#' 
...
GeomPointLine <- ggplot2::ggproto('GeomPointLine',
  ...
  # setup_data from GeomLine to order datapoints left-to-right by x-axis
